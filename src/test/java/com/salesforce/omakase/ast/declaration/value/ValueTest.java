...
public class ValueTest {
    ...
    public void asHexColorNotOnlyOneInTermList() {
        value = TermList.ofValues(TermOperator.SPACE, HexColorValue.of("fff"), NumericalValue.of(1));
        assertThat(Value.asHexColor(value).isPresent()).isFalse();
    }
    ...
    public void asKeywordNotOnlyOneInTermList() {
        value = TermList.ofValues(TermOperator.SPACE, KeywordValue.of(Keyword.NONE), NumericalValue.of(1));
        assertThat(Value.asKeyword(value).isPresent()).isFalse();
    }
    ...
    public void asNumericalNotOnlyOneInTermList() {
        value = TermList.ofValues(TermOperator.SLASH, KeywordValue.of(Keyword.NONE), NumericalValue.of(1));
        assertThat(Value.asNumerical(value).isPresent()).isFalse();
    }
    ...
    public void asStringNotOnlyOneInTermList() {
        value = TermList.ofValues(TermOperator.SPACE, StringValue.of(QuotationMode.DOUBLE, "h"), NumericalValue.of(1));
        assertThat(Value.asString(value).isPresent()).isFalse();
    }

    private static final class OtherPropertyValue extends AbstractSyntax implements PropertyValue {
        @Override
