 ...
 *
 * In most cases this is not the type of plugin that you want for customized (non-library-provided) plugins.
 * Broadcasting your own events may result in unexpected behavior.
 *
 * @author nmcwilliams
 */
