 ...
 * <p/>
 * Validation always occurs <em>after</em> {@link PreProcess}, {@link Observe} and {@link Rework} subscription methods.. This is
 * based on the assumption that validation should happen last, and it prevents validating the same thing over and over as a result
 * of rework or other changes (and also ensures that new or changed units as a result of rework are validated as well).
 * <p/>
