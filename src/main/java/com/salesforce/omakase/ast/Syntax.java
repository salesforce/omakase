 ...
 * 
 * <p> {@link Syntax} objects are used to represent the individual pieces of content of the parsed CSS source, and are
 * the primary objects used to construct the AST (Abstract Syntax Tree). Not all {@link Syntax} objects have content
 * directly associated with them. Some are used to represent the logical grouping of content, such as the {@link Rule}.
 * 
 * <p> Each unit has a particular line and column indicating where it was parsed within the source.
 * 
 * <p> It's important to remember that <em>unrefined</em> Syntax objects, unless validation is performed, may actually
...
public interface Syntax {
     ...
     * 
     * <p> A comment is associated if it either directly belongs to this {@link Syntax} unit, or if it belongs to any of
     * the child {@link Syntax} units within this one.
     * 
     * <p> This is generally the method you want. To get only the comments directly associated with this {@link Syntax}
     * unit (i.e., appear at the beginning of the content of this unit) use {@link #ownComments()} instead.
     * 
     ...
     * 
     * <p> If this {@link Syntax} unit has direct content associated with it (e.g., a {@link Selector}, this will be any
