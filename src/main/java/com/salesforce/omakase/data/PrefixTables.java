...
public final class PrefixTables {
    ...
    static {
        ...
        builder.put(Property.ANIMATION, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION_DELAY, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION_DURATION, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION_NAME, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.OPERA, 20.0);
        builder.put(Property.ANIMATION, Browser.CHROME, 33.0);
        builder.put(Property.ANIMATION_DELAY, Browser.CHROME, 33.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.CHROME, 33.0);
        builder.put(Property.ANIMATION_DURATION, Browser.CHROME, 33.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.CHROME, 33.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.CHROME, 33.0);
        builder.put(Property.ANIMATION_NAME, Browser.CHROME, 33.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.CHROME, 33.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.CHROME, 33.0);
        ...
        builder.put(Property.TRANSFORM, Browser.OPERA, 20.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.OPERA, 20.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.OPERA, 20.0);
        builder.put(Property.TRANSFORM, Browser.CHROME, 33.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.CHROME, 33.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.CHROME, 33.0);
        ...
        builder.put(Property.PERSPECTIVE, Browser.OPERA, 20.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.OPERA, 20.0);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.OPERA, 20.0);
        builder.put(Property.PERSPECTIVE, Browser.CHROME, 33.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.CHROME, 33.0);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.CHROME, 33.0);
        ...
        builder.put(Property.COLUMNS, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_WIDTH, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_GAP, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_RULE, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_COUNT, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_SPAN, Browser.OPERA, 20.0);
        builder.put(Property.COLUMN_FILL, Browser.OPERA, 20.0);
        builder.put(Property.COLUMNS, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_WIDTH, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_GAP, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_RULE, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_COUNT, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_SPAN, Browser.CHROME, 33.0);
        builder.put(Property.COLUMN_FILL, Browser.CHROME, 33.0);
        ...
        builder.put(Property.USER_SELECT, Browser.OPERA, 20.0);
        builder.put(Property.USER_SELECT, Browser.CHROME, 33.0);
    ...
    static {
        ...
        builder.put("keyframes", Browser.OPERA, 20.0);
        builder.put("keyframes", Browser.CHROME, 33.0);
