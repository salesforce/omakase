...
public final class PrefixTables {
    ...
    static {
        ...
        builder.put(Property.ANIMATION, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION_DELAY, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION_DURATION, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION_NAME, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.OPERA, 17.0);
        builder.put(Property.ANIMATION, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION_DELAY, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION_DURATION, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION_NAME, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.CHROME, 31.0);
        builder.put(Property.ANIMATION, Browser.SAFARI, 7.0);
        builder.put(Property.ANIMATION_DELAY, Browser.SAFARI, 7.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.SAFARI, 7.0);
        builder.put(Property.ANIMATION_DURATION, Browser.SAFARI, 7.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.SAFARI, 7.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.SAFARI, 7.0);
        builder.put(Property.ANIMATION_NAME, Browser.SAFARI, 7.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.SAFARI, 7.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.SAFARI, 7.0);
        ...
        builder.put(Property.ANIMATION, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION_DELAY, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION_DIRECTION, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION_DURATION, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION_NAME, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.ANDROID, 4.3);
        builder.put(Property.ANIMATION, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.ANIMATION_DELAY, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.ANIMATION_DURATION, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.ANIMATION_NAME, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.IOS_SAFARI, 7.0);
        ...
        builder.put(Property.TRANSFORM, Browser.OPERA, 17.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.OPERA, 17.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.OPERA, 17.0);
        builder.put(Property.TRANSFORM, Browser.CHROME, 31.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.CHROME, 31.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.CHROME, 31.0);
        builder.put(Property.TRANSFORM, Browser.SAFARI, 7.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.SAFARI, 7.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.SAFARI, 7.0);
        ...
        builder.put(Property.TRANSFORM, Browser.ANDROID, 4.3);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.ANDROID, 4.3);
        builder.put(Property.TRANSFORM_STYLE, Browser.ANDROID, 4.3);
        builder.put(Property.TRANSFORM, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.PERSPECTIVE, Browser.OPERA, 17.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.OPERA, 17.0);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.OPERA, 17.0);
        builder.put(Property.PERSPECTIVE, Browser.CHROME, 31.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.CHROME, 31.0);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.CHROME, 31.0);
        builder.put(Property.PERSPECTIVE, Browser.SAFARI, 7.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.SAFARI, 7.0);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.SAFARI, 7.0);
        ...
        builder.put(Property.PERSPECTIVE, Browser.ANDROID, 4.3);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.ANDROID, 4.3);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.ANDROID, 4.3);
        builder.put(Property.PERSPECTIVE, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.IOS_SAFARI, 7.0);
        ...
        builder.put(Property.COLUMN_WIDTH, Browser.OPERA, 17.0);
        builder.put(Property.COLUMN_GAP, Browser.OPERA, 17.0);
        builder.put(Property.COLUMN_RULE, Browser.OPERA, 17.0);
        builder.put(Property.COLUMN_COUNT, Browser.OPERA, 17.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.OPERA, 17.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.OPERA, 17.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.OPERA, 17.0);
        builder.put(Property.COLUMN_SPAN, Browser.OPERA, 17.0);
        builder.put(Property.COLUMN_FILL, Browser.OPERA, 17.0);
        builder.put(Property.COLUMNS, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_WIDTH, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_GAP, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_RULE, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_COUNT, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_SPAN, Browser.CHROME, 31.0);
        builder.put(Property.COLUMN_FILL, Browser.CHROME, 31.0);
        builder.put(Property.COLUMNS, Browser.SAFARI, 7.0);
        builder.put(Property.COLUMN_WIDTH, Browser.SAFARI, 7.0);
        builder.put(Property.COLUMN_GAP, Browser.SAFARI, 7.0);
        builder.put(Property.COLUMN_RULE, Browser.SAFARI, 7.0);
        builder.put(Property.COLUMN_COUNT, Browser.SAFARI, 7.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.SAFARI, 7.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.SAFARI, 7.0);
        ...
        builder.put(Property.COLUMN_RULE, Browser.ANDROID, 4.3);
        builder.put(Property.COLUMN_COUNT, Browser.ANDROID, 4.3);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.ANDROID, 4.3);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.ANDROID, 4.3);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.ANDROID, 4.3);
        builder.put(Property.COLUMN_SPAN, Browser.ANDROID, 4.3);
        builder.put(Property.COLUMN_FILL, Browser.ANDROID, 4.3);
        builder.put(Property.COLUMNS, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_WIDTH, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_GAP, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_RULE, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_COUNT, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_SPAN, Browser.IOS_SAFARI, 7.0);
        builder.put(Property.COLUMN_FILL, Browser.IOS_SAFARI, 7.0);
    ...
    static {
        ...
        builder.put("keyframes", Browser.OPERA, 17.0);
        builder.put("keyframes", Browser.CHROME, 31.0);
        builder.put("keyframes", Browser.SAFARI, 7.0);
        builder.put("keyframes", Browser.FIREFOX, 15.0);
        builder.put("keyframes", Browser.ANDROID, 4.3);
        builder.put("keyframes", Browser.IOS_SAFARI, 7.0);
