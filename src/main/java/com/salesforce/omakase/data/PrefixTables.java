...
public final class PrefixTables {
    ...
    static {
        ...
        builder.put(Property.ANIMATION, Browser.SAFARI, 7.1);
        builder.put(Property.ANIMATION_DELAY, Browser.SAFARI, 7.1);
        builder.put(Property.ANIMATION_DIRECTION, Browser.SAFARI, 7.1);
        builder.put(Property.ANIMATION_DURATION, Browser.SAFARI, 7.1);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.SAFARI, 7.1);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.SAFARI, 7.1);
        builder.put(Property.ANIMATION_NAME, Browser.SAFARI, 7.1);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.SAFARI, 7.1);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.SAFARI, 7.1);
        ...
        builder.put(Property.ANIMATION, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.ANIMATION_DELAY, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.ANIMATION_DURATION, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.ANIMATION_NAME, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.IOS_SAFARI, 8.0);
        ...
        builder.put(Property.TRANSFORM, Browser.SAFARI, 7.1);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.SAFARI, 7.1);
        builder.put(Property.TRANSFORM_STYLE, Browser.SAFARI, 7.1);
        ...
        builder.put(Property.TRANSFORM, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.IOS_SAFARI, 8.0);
        ...
        builder.put(Property.PERSPECTIVE, Browser.SAFARI, 7.1);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.SAFARI, 7.1);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.SAFARI, 7.1);
        ...
        builder.put(Property.PERSPECTIVE, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.IOS_SAFARI, 8.0);
        ...
        builder.put(Property.COLUMNS, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_WIDTH, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_GAP, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_RULE, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_COUNT, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_SPAN, Browser.SAFARI, 7.1);
        builder.put(Property.COLUMN_FILL, Browser.SAFARI, 7.1);
        ...
        builder.put(Property.COLUMNS, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_WIDTH, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_GAP, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_RULE, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_COUNT, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_SPAN, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.COLUMN_FILL, Browser.IOS_SAFARI, 8.0);
        ...
        builder.put(Property.USER_SELECT, Browser.SAFARI, 7.1);
        ...
        builder.put(Property.USER_SELECT, Browser.IOS_SAFARI, 8.0);
        builder.put(Property.HYPHENS, Browser.IE, 11.0);
        builder.put(Property.HYPHENS, Browser.SAFARI, 7.1);
        builder.put(Property.HYPHENS, Browser.FIREFOX, 33.0);
        builder.put(Property.HYPHENS, Browser.IOS_SAFARI, 8.0);
        ...
        builder.put(Property.APPEARANCE, Browser.SAFARI, 7.1);
        builder.put(Property.APPEARANCE, Browser.ANDROID, 4.4);
        builder.put(Property.APPEARANCE, Browser.IOS_SAFARI, 8.0);
    ...
    static {
        ...
        builder.put("keyframes", Browser.SAFARI, 7.1);
        builder.put("keyframes", Browser.FIREFOX, 15.0);
        builder.put("keyframes", Browser.ANDROID, 4.4);
        builder.put("keyframes", Browser.IOS_SAFARI, 8.0);
    ...
    static {
        ...
        builder.put("placeholder", Browser.SAFARI, 7.1);
        ...
        builder.put("placeholder", Browser.IOS_SAFARI, 8.0);
