...
public final class PrefixTables {
    ...
    static {
        ...
        builder.put(Property.ANIMATION, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION_DELAY, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION_DURATION, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION_NAME, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.OPERA, 22.0);
        builder.put(Property.ANIMATION, Browser.CHROME, 36.0);
        builder.put(Property.ANIMATION_DELAY, Browser.CHROME, 36.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.CHROME, 36.0);
        builder.put(Property.ANIMATION_DURATION, Browser.CHROME, 36.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.CHROME, 36.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.CHROME, 36.0);
        builder.put(Property.ANIMATION_NAME, Browser.CHROME, 36.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.CHROME, 36.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.CHROME, 36.0);
        ...
        builder.put(Property.ANIMATION, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.ANIMATION_DELAY, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.ANIMATION_DIRECTION, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.ANIMATION_DURATION, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.ANIMATION_NAME, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.IOS_SAFARI, 7.1);
        ...
        builder.put(Property.TRANSFORM, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.TRANSFORM_STYLE, Browser.IOS_SAFARI, 7.1);
        ...
        builder.put(Property.PERSPECTIVE, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.IOS_SAFARI, 7.1);
        ...
        builder.put(Property.COLUMNS, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_WIDTH, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_GAP, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_RULE, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_COUNT, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_SPAN, Browser.OPERA, 22.0);
        builder.put(Property.COLUMN_FILL, Browser.OPERA, 22.0);
        builder.put(Property.COLUMNS, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_WIDTH, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_GAP, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_RULE, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_COUNT, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_SPAN, Browser.CHROME, 36.0);
        builder.put(Property.COLUMN_FILL, Browser.CHROME, 36.0);
        ...
        builder.put(Property.COLUMNS, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_WIDTH, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_GAP, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_RULE, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_COUNT, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_SPAN, Browser.FIREFOX, 31.0);
        builder.put(Property.COLUMN_FILL, Browser.FIREFOX, 31.0);
        ...
        builder.put(Property.COLUMNS, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_WIDTH, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_GAP, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_RULE, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_COUNT, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_SPAN, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.COLUMN_FILL, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.USER_SELECT, Browser.IE, 11.0);
        builder.put(Property.USER_SELECT, Browser.OPERA, 22.0);
        builder.put(Property.USER_SELECT, Browser.CHROME, 36.0);
        builder.put(Property.USER_SELECT, Browser.SAFARI, 7.0);
        builder.put(Property.USER_SELECT, Browser.FIREFOX, 31.0);
        builder.put(Property.USER_SELECT, Browser.ANDROID, 4.4);
        builder.put(Property.USER_SELECT, Browser.IE_MOBILE, 10.0);
        builder.put(Property.USER_SELECT, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.HYPHENS, Browser.IE, 11.0);
        builder.put(Property.HYPHENS, Browser.SAFARI, 7.0);
        builder.put(Property.HYPHENS, Browser.FIREFOX, 31.0);
        builder.put(Property.HYPHENS, Browser.IOS_SAFARI, 7.1);
        builder.put(Property.TAB_SIZE, Browser.OPERA, 12.1);
        builder.put(Property.TAB_SIZE, Browser.FIREFOX, 31.0);
        builder.put(Property.APPEARANCE, Browser.FIREFOX, 31.0);
        builder.put(Property.APPEARANCE, Browser.CHROME, 36.0);
        builder.put(Property.APPEARANCE, Browser.SAFARI, 7.0);
        builder.put(Property.APPEARANCE, Browser.ANDROID, 4.4);
        builder.put(Property.APPEARANCE, Browser.IOS_SAFARI, 7.1);
    ...
    static {
        ...
        builder.put("keyframes", Browser.OPERA, 22.0);
        builder.put("keyframes", Browser.CHROME, 36.0);
        ...
        builder.put("keyframes", Browser.IOS_SAFARI, 7.1);
    ...
    static {
        ...
        builder.put("selection", Browser.FIREFOX, 31.0);
        builder.put("placeholder", Browser.IE, 11.0);
        builder.put("placeholder", Browser.OPERA, 22.0);
        builder.put("placeholder", Browser.CHROME, 36.0);
        builder.put("placeholder", Browser.SAFARI, 7.0);
        builder.put("placeholder", Browser.FIREFOX, 31.0);
        builder.put("placeholder", Browser.ANDROID, 4.4);
        builder.put("placeholder", Browser.IE_MOBILE, 10.0);
        builder.put("placeholder", Browser.IOS_SAFARI, 7.1);
