...
public final class PrefixTables {
    ...
    static {
        ...
        builder.put(Property.ANIMATION, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION_DELAY, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION_DURATION, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION_NAME, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.OPERA, 19.0);
        builder.put(Property.ANIMATION, Browser.CHROME, 32.0);
        builder.put(Property.ANIMATION_DELAY, Browser.CHROME, 32.0);
        builder.put(Property.ANIMATION_DIRECTION, Browser.CHROME, 32.0);
        builder.put(Property.ANIMATION_DURATION, Browser.CHROME, 32.0);
        builder.put(Property.ANIMATION_FILL_MODE, Browser.CHROME, 32.0);
        builder.put(Property.ANIMATION_ITERATION_COUNT, Browser.CHROME, 32.0);
        builder.put(Property.ANIMATION_NAME, Browser.CHROME, 32.0);
        builder.put(Property.ANIMATION_PLAY_STATE, Browser.CHROME, 32.0);
        builder.put(Property.ANIMATION_TIMING_FUNCTION, Browser.CHROME, 32.0);
        ...
        builder.put(Property.TRANSFORM, Browser.OPERA, 19.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.OPERA, 19.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.OPERA, 19.0);
        builder.put(Property.TRANSFORM, Browser.CHROME, 32.0);
        builder.put(Property.TRANSFORM_ORIGIN, Browser.CHROME, 32.0);
        builder.put(Property.TRANSFORM_STYLE, Browser.CHROME, 32.0);
        ...
        builder.put(Property.PERSPECTIVE, Browser.OPERA, 19.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.OPERA, 19.0);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.OPERA, 19.0);
        builder.put(Property.PERSPECTIVE, Browser.CHROME, 32.0);
        builder.put(Property.PERSPECTIVE_ORIGIN, Browser.CHROME, 32.0);
        builder.put(Property.BACKFACE_VISIBILITY, Browser.CHROME, 32.0);
        ...
        builder.put(Property.BOX_SIZING, Browser.FIREFOX, 27.0);
        builder.put(Property.BOX_SIZING, Browser.ANDROID, 3.0);
        builder.put(Property.BOX_SIZING, Browser.IOS_SAFARI, 4.3);
        builder.put(Property.COLUMNS, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_WIDTH, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_GAP, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_RULE, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_COUNT, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_SPAN, Browser.OPERA, 19.0);
        builder.put(Property.COLUMN_FILL, Browser.OPERA, 19.0);
        builder.put(Property.COLUMNS, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_WIDTH, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_GAP, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_RULE, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_COUNT, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_SPAN, Browser.CHROME, 32.0);
        builder.put(Property.COLUMN_FILL, Browser.CHROME, 32.0);
        ...
        builder.put(Property.COLUMNS, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_WIDTH, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_GAP, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_RULE, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_COUNT, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_RULE_COLOR, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_RULE_WIDTH, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_RULE_STYLE, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_SPAN, Browser.FIREFOX, 27.0);
        builder.put(Property.COLUMN_FILL, Browser.FIREFOX, 27.0);
        ...
        builder.put(Property.USER_SELECT, Browser.OPERA, 19.0);
        builder.put(Property.USER_SELECT, Browser.CHROME, 32.0);
        builder.put(Property.USER_SELECT, Browser.SAFARI, 7.0);
        builder.put(Property.USER_SELECT, Browser.FIREFOX, 27.0);
        ...
        builder.put(Property.HYPHENS, Browser.FIREFOX, 27.0);
    ...
    static {
        ...
        builder.put("keyframes", Browser.OPERA, 19.0);
        builder.put("keyframes", Browser.CHROME, 32.0);
