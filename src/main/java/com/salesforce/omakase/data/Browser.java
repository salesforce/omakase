...
public enum Browser {
    ...
    /** The 'Safari' browser */
    SAFARI("safari", "Safari", Prefix.WEBKIT, ImmutableList.of(7.1,7.0,6.1,6.0,5.1,5.0,4.0,3.2,3.1)),
    ...
    IOS_SAFARI("ios_saf", "Safari on iOS", Prefix.WEBKIT, ImmutableList.of(8.0,7.1,7.0,6.1,6.0,5.1,5.0,4.3,4.2,4.1,4.0,3.2)),
