...
public enum Browser {
    ...
    /** The 'Opera' browser */
    OPERA("opera", "Opera", Prefix.O, ImmutableList.of(22.0,21.0,20.0,19.0,18.0,17.0,16.0,15.0,12.1,12.0,11.6,11.5,11.1,11.0,10.6,10.5,10.1,10.0,9.6,9.5)),

    /** The 'Chrome' browser */
    CHROME("chrome", "Chrome", Prefix.WEBKIT, ImmutableList.of(36.0,35.0,34.0,33.0,32.0,31.0,30.0,29.0,28.0,27.0,26.0,25.0,24.0,23.0,22.0,21.0,20.0,19.0,18.0,17.0,16.0,15.0,14.0,13.0,12.0,11.0,10.0,9.0,8.0,7.0,6.0,5.0,4.0)),

    /** The 'Safari' browser */
    SAFARI("safari", "Safari", Prefix.WEBKIT, ImmutableList.of(7.0,6.1,6.0,5.1,5.0,4.0,3.2,3.1)),

    /** The 'Firefox' browser */
    FIREFOX("firefox", "Firefox", Prefix.MOZ, ImmutableList.of(31.0,30.0,29.0,28.0,27.0,26.0,25.0,24.0,23.0,22.0,21.0,20.0,19.0,18.0,17.0,16.0,15.0,14.0,13.0,12.0,11.0,10.0,9.0,8.0,7.0,6.0,5.0,4.0,3.6,3.5,3.0,2.0)),
    ...
    IOS_SAFARI("ios_saf", "Safari on iOS", Prefix.WEBKIT, ImmutableList.of(7.1,7.0,6.1,6.0,5.1,5.0,4.3,4.2,4.1,4.0,3.2)),

    /** The 'Opera Mini' browser */
    OPERA_MINI("op_mini", "Opera Mini", Prefix.O, ImmutableList.of(7.0,5.0)),
